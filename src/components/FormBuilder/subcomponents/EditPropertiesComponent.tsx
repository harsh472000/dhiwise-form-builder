  ...
  return (
    <>
      {selectedControl ? (
        ...
        label="Button Type"
        name="buttonType"
        value={childUpdatedItem.buttonType}
        onChange={handleChange}
        style={textboxStyle}
      >
        ...
        <MenuItem value="secondary">Secondary</MenuItem>
                  ...
                  <input
                    type="submit"
                    className="btn btn-primary m-t-20 m-r-10"
                    value="Update"
                  />
                  <input
                    type="button"
                    className="btn btn-light m-t-20 m-l-0"
                    value="Cancel"
                    onClick={() => {
                      if (selectControl) {
                        selectControl(undefined);
        ...
        <>
          ...
          >
            <h4>Note</h4>
            You need to select a container/Element to edit properties.
          </div>
        </>
      )}
    </>
